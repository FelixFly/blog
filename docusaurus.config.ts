      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            {type: 'html', value: '<strong>终端工具链</strong>', className: 'dropdown-section-title'},
            {label: 'Ghostty + x-cmd + tmux', to: '/docs/devops/ghostty-xcmd-tmux-setup'},
        ...
        },
        {
          ...
          items: [
            ...
            {label: 'AI 编程工具全景', to: '/docs/ai/ai-coding-tools-guide'},
            {label: '记忆系统', to: '/docs/ai/claude-code-memory'},
            {label: 'Skill 指南', to: '/docs/ai/claude-code-skill-guide'},
            {label: 'BMAD 方法论', to: '/docs/ai/bmad-method'},
            {label: 'BMAD + Team Mode', to: '/docs/ai/bmad-team-mode'},
